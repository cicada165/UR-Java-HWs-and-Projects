 ...
 * class</q> (Bison manual, Section 10.2.5). Token values are accessible as
 * public static final ints in the parser class.
 */
public class BIFLexer implements BIFParser.Lexer {

	/**
	 * Construct and return a new BIFLexer reading from the given InputStream. It
	 * would be easy to add variations on this, or even make it so you could change
	...
	/**
	 * Lexer method: Used to report an error message. As has been the case since the
	 * days of yacc, this is pretty useless since it only ever gets "syntax error"
	 * and can't throw an exception anyway because of the signature in the Lexer
	 * interface. But has to be defined.
	 */
	...
	/**
	 * Lexer method: Return the next token and set yylval appropriately. Returns 0
	 * on EOF, -1 or error, otherwise a token code (>0).
	 */
	...
	/**
	 * Report an error by throwing a ParserException. Probably should do something
	 * different now that we're in bison.
	 */
	...
	/**
	 * Read and return the next character from the input, keeping track of line and
	 * character locations for error reporting.
	 */
	...
	/**
	 * Push the given character back onto the input, keeping track of line and
	 * character locations for error reporting.
	 */
	...
	/**
	 * Return true if given character is a
	 * <q>letter</q> as defined by the BIF specification:
	 * {@code ["a"-"z","A"-"Z","_","-"]}.
	 */
	...
	/**
	 * Return value of given character as a decimal digit (i.e., number from 0 to
	 * 9).
	 */
	...
	/**
	 * Attempt to recover from the previous error, whetever it was. The strategy is
	 * to read up to and including a semi-colon. It might work (for simple errors).
	 */
