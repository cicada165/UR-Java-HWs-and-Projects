...
/**
 * Base implementation of Values allows you to wrap any other type and make
 * instance of that type into Values.
 */
public class Value<T> implements bn.core.Value {
	...
	/**
	 * Return true if the given object is a StringValue (not null) and its value (a
	 * String) is String.equals to this StringValue's value (which is also a
	 * String). Whew!
	 */
