...
/**
 * Base implementation of a RandomVariable that has a name as well as its Domain
 * of Values.
 */
public class NamedVariable implements RandomVariable, Named {
	...
	/*
	 * Not sure this is needed since we don't actually compare RandomVariables to
	 * each other using equals(). So the default hashCode() implementation may be
	 * sufficient.
	 * 
