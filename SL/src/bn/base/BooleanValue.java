...
public class BooleanValue extends Value<Boolean> {
	...
	/**
	 * Return the Boolean value of this BooleanValue, if you follow me. Note that
	 * this constructor is protected to prevent new instances other than TRUE and
	 * FALSE from being created.
	 */
	...
	/**
	 * Returns the BooleanValue TRUE if the given boolean is true, otherwise FALSE
	 * if it false.
	 */
	...
	/**
	 * Returns the BooleanValue TRUE if the given String is "true" (ignoring case),
	 * FALSE if the given string is "false" (ditto), and throws an
	 * IllegalArgumentException for anything else. Note that Boolean.valueOf returns
	 * TRUE for "true" and FALSE for anything else. Why would they do that?
	 */
