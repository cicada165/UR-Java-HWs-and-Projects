...
/**
 * A Map implementation backed by an ArraySet. Good for small, more or less
 * immutable maps, but not part of Java.
 */
public class ArrayMap<K, V> extends AbstractMap<K, V> {
	...
	/**
	 * Returns a Set view of the mappings contained in this map. Required by
	 * subclasses of AbstractMap.
	 */
	@Override
	 ...
	 * Required by AbstractMap for mutable maps. It could perhaps be implemented
	 * more efficiently...
	 */
	@Override
