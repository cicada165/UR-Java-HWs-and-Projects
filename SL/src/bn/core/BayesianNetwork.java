...
/**
 * A BayesianNetwork is a directed acyclic graph where the nodes correspond to
 * RandomVariables and store the conditional distribution of their variable
 * given its parents.
 */
public interface BayesianNetwork {
	...
	/**
	 * Return the RandomVariables used in this BayesianNetwork sorted topologically
	 * (so that parents precede their children).
	 */
	 ...
	 * the Values of its parents (and of itself) in the given Assignment.
	 */
